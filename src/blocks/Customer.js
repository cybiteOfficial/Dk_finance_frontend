...
import {
	...
	fetchCustomersByApplicantIdDataThunk,
	fetchPdfDataThunk,
	fileForwardedThunk,
	removeCustomer,
	setCustomer,
...
export const Customers = () => {
	...
	const { customerDetails, applicantData } = useSelector(
	...
	const addForm = () => {
		...
		dispatch(
			setCustomer({ selectedCustomer: { item, data }, type: "setCustomer" })
		);
	...
	const downloadPdf = async () => {
		const applicantExists = customerDetails.some(
